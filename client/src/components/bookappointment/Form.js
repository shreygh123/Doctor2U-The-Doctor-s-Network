...
const Form = ({profile, doctorId,history, addAppointment}) => {
	...
	async function displayRazorpay() {
		...
		const options = {
			...
			prefill: {
				name,
				email: 'shreyashghuge@gmail.com',
				phone_number: '8554993117'
			}
		}
        ...
        <br />
            ...
            <form onSubmit={e => {
                ...
                <div className="form-group">
                    ...
                    <div className="form-group">
                    <a href='https://calendar.google.com/calendar/appointments/schedules/AcZssZ3T7soTan-Se3VZq3su2yBvzIaxueG5ymPh14zMDQ1xdEWVXPZuezdUsYXg_T3b8bQoh0dJOi8S' class="btn btn-danger  d-grid gap-2 col-6 mx-auto btn-md text-light" target='_blank' >Book Appointment</a>
                </div>
